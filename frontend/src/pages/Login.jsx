      ...
      >
        ...
        <IconButton
          ...
          sx={{
            ...
            "&:hover": {
              transform: "scale(1.1)",
              bgcolor: mode === "light" ? "white" : "rgba(255,255,255,0.12)",
            },
          }}
        >
          {mode === "light" ? (
          ...
          <Box sx={{ mb: 4, mt: 2 }}>
            ...
            >
              {isLogin
                ...
                : "Join the OurSpaceOS community today."}
            </Typography>
          </Box>
        </motion.div>
            ...
            <TextField
              ...
              sx={{
                "& .MuiOutlinedInput-root": {
                  ...
                  backdropFilter: "blur(10px)",
                  border:
                    mode === "light" ? "1px solid rgba(0,0,0,0.05)" : "none",
                  "& fieldset": { border: "none" },
                  "&.Mui-focused fieldset": {
                    border: `2px solid ${theme.palette.primary.main}`,
                  },
            ...
            <Box sx={{ mt: 6 }}>
              <Button
                ...
                sx={{
                  ...
                  boxShadow:
                    mode === "light"
                      ? "0 8px 16px -4px rgba(11, 87, 208, 0.3)"
                  ...
                  "&:hover": {
                    ...
                    boxShadow: isFormValid
                      ? mode === "light"
                        ? "0 12px 20px -4px rgba(11, 87, 208, 0.4)"
                        : "0 12px 20px -4px rgba(0,0,0,0.6)"
                      : "none",
                  },
                  transition: "all 0.3s cubic-bezier(0.4, 0, 0.2, 1)",
                }}
